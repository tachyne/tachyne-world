...
func session(c net.Conn, cfg Config) {
	...
	for {
		...
		case proto.MsgPaddleBoat:
			actTo(remote, payload, proto.PaddleBoat{})
		case proto.MsgPickItem:
			actTo(remote, payload, proto.PickItem{})
		...
		case proto.MsgSlotState:
			actTo(remote, payload, proto.SlotState{})
