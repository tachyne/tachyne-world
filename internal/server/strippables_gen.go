// Code generated by scripts/gen_strippables.py from the vanilla datapack. DO NOT EDIT.

package server

// stripPairs are the axe's strip rules (canonical 26.3): block, stripped block.
