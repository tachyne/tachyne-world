...
var numericRules = []string{"max_block_modifications", "random_tick_speed", "players_sleeping_percentage", "max_entity_cramming", "respawn_radius", "max_snow_accumulation_height",
