...
// vanilla tidy tree. 125 advancements, 403 criteria (1 not yet
...
var advTable = []advNode{
	...
	},
	{
		...
		criteria: []advCriterion{
			{name: "ride_a_boat_with_a_goat", trigger: "started_riding", passenger: "goat", vehicles: []string{"oak_boat", "spruce_boat", "birch_boat", "jungle_boat", "acacia_boat", "cherry_boat", "dark_oak_boat", "pale_oak_boat", "mangrove_boat", "bamboo_raft"}},
		},
		reqs: [][]string{
