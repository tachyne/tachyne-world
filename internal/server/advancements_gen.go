...
// vanilla tidy tree. 125 advancements, 403 criteria (9 not yet
...
var advTable = []advNode{
	...
	},
	{
		...
		criteria: []advCriterion{
			{name: "honey_block_slide", trigger: "slide_down_block", unmatchable: true, blocks: []string{"honey_block"}},
		},
		reqs: [][]string{
			{"honey_block_slide"},
		},
	...
	},
	{
		...
		criteria: []advCriterion{
			{name: "chiseled_bookshelf", trigger: "placed_block", locChecks: [][]advLocCheck{{{dx: 0, dy: 0, dz: 0, blocks: []string{"chiseled_bookshelf"}, props: map[string]string{}}}, {{dx: 0, dy: 0, dz: 1, blocks: []string{"comparator"}, props: map[string]string{"facing": "north"}}}, {{dx: 0, dy: 0, dz: -1, blocks: []string{"comparator"}, props: map[string]string{"facing": "south"}}}, {{dx: 1, dy: 0, dz: 0, blocks: []string{"comparator"}, props: map[string]string{"facing": "west"}}}, {{dx: -1, dy: 0, dz: 0, blocks: []string{"comparator"}, props: map[string]string{"facing": "east"}}}}},
	...
	},
	{
		...
		criteria: []advCriterion{
			{name: "struck_villager", trigger: "channeled_lightning", unmatchable: true, victims: []string{"villager"}},
		},
		reqs: [][]string{
			{"struck_villager"},
		},
	...
	},
	{
		...
		criteria: []advCriterion{
			{name: "allay_deliver_cake_to_note_block", trigger: "allay_drop_item_on_block", unmatchable: true, items: [][]int32{{1085}}, blocks: []string{"note_block"}},
		},
		reqs: [][]string{
	...
	},
	{
		...
		criteria: []advCriterion{
			{name: "allay_deliver_item_to_player", trigger: "thrown_item_picked_up_by_player", unmatchable: true, entity: "allay"},
		},
		reqs: [][]string{
	...
	},
	{
		...
		criteria: []advCriterion{
			{name: "ride_a_boat_with_a_goat", trigger: "started_riding", unmatchable: true, vehicle: "oak_boat", passenger: "goat"},
		},
		reqs: [][]string{
	...
	},
	{
		...
		criteria: []advCriterion{
			{name: "distract_piglin", trigger: "thrown_item_picked_up_by_entity", unmatchable: true, entity: "piglin", items: [][]int32{{70, 71, 80, 86, 92, 765, 907, 908, 926, 927, 928, 929, 930, 974, 975, 976, 977, 986, 987, 1054, 1129, 1232, 1257, 1300, 1334, 1362, 1388}}, baby: 0, hasBaby: true},
