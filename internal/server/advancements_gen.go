...
// vanilla tidy tree. 126 advancements, 407 criteria (1 not yet
...
var advTable = []advNode{
	...
	},
	{
		...
		criteria: []advCriterion{
			{name: "give_tnt_directly", trigger: "player_interacted_with_entity", entity: "sulfur_cube", items: [][]int32{{853}}, baby: 0, hasBaby: true},
			{name: "pick_up_dropped_tnt", trigger: "thrown_item_picked_up_by_entity", entity: "sulfur_cube", items: [][]int32{{853}}, baby: 0, hasBaby: true},
		},
		reqs: [][]string{
