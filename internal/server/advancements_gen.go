...
var advTable = []advNode{
	...
	},
	{
		...
		criteria: []advCriterion{
			{name: "minecraft:cold", trigger: "player_interacted_with_entity", entity: "frog", items: [][]int32{{1261}}},
			{name: "minecraft:temperate", trigger: "player_interacted_with_entity", entity: "frog", items: [][]int32{{1261}}},
			{name: "minecraft:warm", trigger: "player_interacted_with_entity", entity: "frog", items: [][]int32{{1261}}},
		},
		reqs: [][]string{
			{"minecraft:cold"},
			{"minecraft:temperate"},
