...
var supportNames = map[SupportKind][]string{
	...
	SupportCeiling: {
		...
		"oak_hanging_sign", "pale_hanging_moss", "pale_oak_hanging_sign", "poplar_hanging_sign",
	...
	SupportFace: {
		...
		"lever", "mangrove_button", "oak_button", "pale_oak_button", "poplar_button",
	...
	SupportFloor: {
		...
		"orange_candle_cake", "orange_carpet", "pale_oak_door", "poplar_door",
		"pale_oak_pressure_plate", "poplar_pressure_plate", "pale_oak_sign", "poplar_sign", "pink_banner", "pink_candle",
	...
	SupportSoil: {
		...
		"orange_tulip", "oxeye_daisy", "pale_oak_sapling", "poplar_sapling", "peony",
	...
	SupportWall: {
		...
		"orange_wall_banner", "pale_oak_wall_sign", "poplar_wall_sign", "pink_wall_banner",
