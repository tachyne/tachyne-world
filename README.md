...
| Books | ✅ | Book and quill: write up to 100 pages, sign to a titled written book (author = you, generation 0), read via the vanilla book screen; contents persist with the world and follow the book through chests, frames, drops and deaths. Lectern and chiseled bookshelf next. |
