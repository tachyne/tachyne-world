...
and so are its loot, recipes and fuel, with 26.3's new building blocks (wool
and concrete stairs and slabs, the poplar wood set); worldgen and
advancements are still 1.21.11's while 26.3's reworked data formats are
brought in piece by piece, each with the content it adds.
