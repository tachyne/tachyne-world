...
| PvP | 🟡 | Melee between players runs the full swing — weapon damage, the 1.9 attack cooldown, criticals, mace smash, Knockback and Fire Aspect — against the same armour, protection, shield and absorption pipeline mobs hit. Gated on the `pvp` gamerule. Thorns retaliation between players and player-fired projectile hits are still to come. |
