...
8. Decorated pots ~~(one item per insert, persistence)~~, brewing-stand feedback and persistence, per-item stack caps ~~(2026-09-20)~~ — pot sherds remain; spawners now show the mob turning in the cage (2026-09-20), though block entities that come from world generation still carry no data to the client
